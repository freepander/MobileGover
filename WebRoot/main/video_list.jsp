		...
		<table cellspacing="0" class="table table-bordered">
			<thead>
				<tr>
					<th colspan="5">
						<ul class="toolbar">
							<li><a href="curl/video_input" class="button button-success">添加</a></li>
						</ul>
					</th>
				</tr>
				<tr>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="curl/video_delete?id=<s:property value="id"/>" class="button button-danger"><i class="icon-white icon-trash"></i>删除</a> 
						<a href="curl/video_input?id=<s:property value="id"/>" class="button button-warning">更改</a>
					</td>
				</tr>
				</s:iterator>
			</tbody>
